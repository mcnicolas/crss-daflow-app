...
-- Ran at: 9/28/17 2:37 PM
-- Against: postgres@jdbc:postgresql://localhost:5432/crss_test?currentSchema=dataflow
-- Liquibase version: 3.5.3
-- *********************************************************************

-- Lock Database
UPDATE dataflow.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = '192.168.242.31 (192.168.242.31)', LOCKGRANTED = '2017-09-28 14:37:43.065' WHERE ID = 1 AND LOCKED = FALSE;
...
CREATE TABLE dataflow.batch_job_queue (id BIGINT NOT NULL, details VARCHAR(2000), job_exec_end TIMESTAMP WITHOUT TIME ZONE, job_exec_start TIMESTAMP WITHOUT TIME ZONE, job_execution_id BIGINT, job_name VARCHAR(255) NOT NULL, module INT NOT NULL, queue_date TIMESTAMP WITHOUT TIME ZONE NOT NULL, run_id BIGINT NOT NULL, source VARCHAR(255), status VARCHAR(255) NOT NULL, task_obj VARCHAR(20000) NOT NULL, "user" VARCHAR(255));

INSERT INTO dataflow.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('1506580618314-3', 'dmendoza (generated)', 'src/main/resources/liquibase/2.3.0/schema/changelog-1506580616475.groovy', NOW(), 25, '7:9deb336206c7aa2094e1e70edfd6cf6a', 'createTable tableName=batch_job_queue', '', 'EXECUTED', NULL, NULL, '3.5.3', '6580663389');
