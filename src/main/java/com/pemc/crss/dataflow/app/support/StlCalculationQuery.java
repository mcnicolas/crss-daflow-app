...
public class StlCalculationQuery {
    public static final String CALC_JOB_NAME_ADJ = "calcSTL_AMTMonthlyAdjusted-";
    public static final String CALC_JOB_NAME_FINAL = "calcSTL_AMTMonthlyFinal-";
    public static final String CALC_JOB_NAME_PRELIM = "calcSTL_AMTMonthlyPrelim-";
    public static final String CALC_JOB_NAME_DAILY = "calcSTL_AMTDaily-";
