...
-- Ran at: 8/16/17 12:48 PM
-- Against: postgres@jdbc:postgresql://localhost:5432/crss_test?currentSchema=dataflow
-- Liquibase version: 3.5.3
-- *********************************************************************

-- Lock Database
UPDATE dataflow.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = '192.168.242.31 (192.168.242.31)', LOCKGRANTED = '2017-08-16 12:48:01.946' WHERE ID = 1 AND LOCKED = FALSE;

-- Changeset src/main/resources/liquibase/2.2.0/schema/changelog-1501669448827.groovy::1501669449638-1::dmendoza (generated)
CREATE TABLE dataflow.SETTLEMENT_JOB_LOCK (id BIGINT NOT NULL, created_datetime TIMESTAMP WITHOUT TIME ZONE, end_date TIMESTAMP WITHOUT TIME ZONE NOT NULL, group_id VARCHAR(255) NOT NULL, locked_ta BOOLEAN NOT NULL, locked_emf BOOLEAN NOT NULL, locked_rmf BOOLEAN NOT NULL, parent_job_id BIGINT NOT NULL, process_type VARCHAR(255), start_date TIMESTAMP WITHOUT TIME ZONE NOT NULL);

INSERT INTO dataflow.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('1501669449638-1', 'dmendoza (generated)', 'src/main/resources/liquibase/2.2.0/schema/changelog-1501669448827.groovy', NOW(), 19, '7:cb98057026f4b416053aebd5ee466aa2', 'createTable tableName=SETTLEMENT_JOB_LOCK', '', 'EXECUTED', NULL, NULL, '3.5.3', '2858882225');
