...
public interface DataFlowJobExecutionDao {
     ...
     */
    List<JobExecution> findJobExecutions(JobInstance jobInstance, String status, String mode, String runStartDate,
                                         String runEndDate, String tradingStartDate, String tradingEndDate);
