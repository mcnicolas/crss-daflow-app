...
CREATE TABLE dataflow.SETTLEMENT_JOB_LOCK (id BIGINT NOT NULL, created_datetime TIMESTAMP WITHOUT TIME ZONE, end_date TIMESTAMP WITHOUT TIME ZONE NOT NULL, group_id BIGINT NOT NULL, locked BOOLEAN NOT NULL, parent_job_id BIGINT NOT NULL, process_type VARCHAR(255), start_date TIMESTAMP WITHOUT TIME ZONE NOT NULL);
